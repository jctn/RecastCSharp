...
namespace RecastSharp
{
    public static partial class Recast
    {
        ...
        static bool rasterizeTri(float[] v0, int v0Start, float[] v1, int v1Start, float[] v2, int v2Start,
        ...
        ///
        /// @see rcHeightfield
        public static void rcRasterizeTriangle(rcContext ctx, float[] v0, int v0Start, float[] v1, int v1Start,
            float[] v2, int v2Start,
            ...
            int flagMergeThr)
        {
            ...
            rasterizeTri(v0, v0Start, v1, v1Start, v2, v2Start, area, solid, solid.bmin, solid.bmax, solid.cs, ics, ich,
                flagMergeThr);
        ...
        ///
        /// @see rcHeightfield
        public static bool rcRasterizeTriangles(rcContext ctx, float[] verts, byte[] areas, int nt,
            rcHeightfield solid, int flagMergeThr)
        {
            Debug.Assert(ctx != null, "rcContext is null");
